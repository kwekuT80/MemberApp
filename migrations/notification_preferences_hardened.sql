...
GRANT SELECT, INSERT, UPDATE ON TABLE public.reminder_log TO authenticated;
...
CREATE INDEX IF NOT EXISTS idx_profiles_notification ON public.profiles (phone, notification_channel) WHERE phone IS NOT NULL;
