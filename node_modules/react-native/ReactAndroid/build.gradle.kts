...
val prepareDoubleConversion by
    tasks.registering(Copy::class) {
      ...
      include("double-conversion-${DOUBLE_CONVERSION_VERSION}/src/**/*", "implement.txt")
...
val prepareFolly by
    tasks.registering(Copy::class) {
      ...
      include("folly-${FOLLY_VERSION}/folly/**/*", "implement.txt")
...
val prepareFmt by
    tasks.registering(Copy::class) {
      ...
      include("fmt-${FMT_VERSION}/src/**/*", "fmt-${FMT_VERSION}/include/**/*", "implement.txt")
...
android {
  ...
  externalNativeBuild {
    cmake {
      ...
      path("src/main/jni/implement.txt")
    }
  }
