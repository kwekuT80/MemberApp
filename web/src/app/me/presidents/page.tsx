          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            <div>
              ...
              <p style={{ margin: '6px 0 0', fontSize: 13, color: '#94A3B8', maxWidth: 640 }}>
                Official succession roll of the 12 Worthy Presidents who have presided over St. Margaret-Mary Commandery No. 500 since 1996.
              </p>
            </div>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.08)', padding: '12px 18px', borderRadius: 12, border: '1px solid rgba(255, 255, 255, 0.12)', textAlign: 'center' }}>
              <div style={{ fontSize: 22, fontWeight: 900, color: '#F59E0B', fontFamily: 'monospace' }}>12 Presidents</div>
              <div style={{ fontSize: 11, fontWeight: 700, color: '#CBD5E1', marginTop: 2 }}>1996 – 2025 (30 Years)</div>
            </div>
          </div>
        </div>
