                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div style={{ background: 'white', padding: 4, borderRadius: 6, width: 52, height: 52, flexShrink: 0 }}>
                      <img 
                        src={`https://quickchart.io/qr?text=${encodeURIComponent(typeof window !== 'undefined' ? window.location.origin + '/verify/' + member.id : 'https://ksji-members.vercel.app/verify/' + member.id)}&size=120&margin=1`} 
                        alt="QR Code" 
