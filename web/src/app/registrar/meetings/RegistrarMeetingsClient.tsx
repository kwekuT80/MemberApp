      ...
      <div style={{ display: 'grid', gap: 24, alignContent: 'start' }}>
        {selectedMeeting ? (
          <>
            ...
            {/* Absence Excuse Requests Panel */}
            {absenceRequests.length > 0 && (
              <div className="card" style={{ border: '1px solid rgba(3, 105, 161, 0.2)', background: 'rgba(3, 105, 161, 0.01)', display: 'grid', gap: 16 }}>
                <div>
                  <h3 style={{ margin: '0 0 4px', fontSize: 16, color: '#0369a1', fontWeight: 800 }}>✉️ Pending Absence Requests</h3>
                  <p style={{ margin: 0, fontSize: 12, color: '#0284c7' }}>Review excuses submitted by members for this meeting.</p>
                </div>
