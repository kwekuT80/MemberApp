...
const WORTHY_PRESIDENTS: WorthyPresidentItem[] = [
  { no: 1,  title: 'N Bro.', name: 'Thomas Kwao Nyaku',        tenure: '1996–1997', duration: '2 years', status: 'Deceased', isDeceased: true,  memberId: '05ca54dc-0a41-49d2-9ec1-394d1a29bd0a' },
  { no: 2,  title: 'N Bro.', name: 'John Fifi Sackey',          tenure: '1998–2001', duration: '4 years', status: 'Deceased', isDeceased: true,  memberId: '74b2a9e9-496c-4070-b0b9-db017d2bf133' },
  { no: 3,  title: 'N Bro.', name: 'Paul Kwofie',              tenure: '2002–2003', duration: '2 years', status: 'Deceased', isDeceased: true,  memberId: '3af1481b-597a-4944-9359-d059981e5bb5' },
  { no: 4,  title: 'N Bro.', name: 'Oscar Bongne',             tenure: '2004–2005', duration: '2 years', status: 'Active',   isDeceased: false, memberId: '78ef4d82-49eb-407f-9c6a-ce61967567c9' },
  { no: 5,  title: 'N Bro.', name: 'Ben Hagan',                tenure: '2006–2007', duration: '2 years', status: 'Active',   isDeceased: false, memberId: '9248180a-bb6b-4106-8ac1-49c9fc1fc103' },
  ...
  { no: 7,  title: 'N Bro.', name: 'John Cozy Clottey',        tenure: '2012–2013', duration: '2 years', status: 'Deceased', isDeceased: true,  memberId: '125ca3a2-3470-49d9-88d9-9b97dc7831f1' },
  { no: 8,  title: 'N Bro.', name: 'Paul Amati',               tenure: '2014–2015', duration: '2 years', status: 'Active',   isDeceased: false, memberId: '589fd6ed-503f-4d37-9826-22c2cb1e9975' },
  { no: 9,  title: 'N Bro.', name: 'Francis Ahiafor',          tenure: '2016–2017', duration: '2 years', status: 'Deceased', isDeceased: true,  memberId: 'fd3733e6-a58b-4734-b244-291ab819441b' },
  { no: 10, title: 'N Bro.', name: 'David Bondorin',           tenure: '2018–2019', duration: '2 years', status: 'Active',   isDeceased: false, memberId: '6b5e9719-51f6-43d2-9500-168c9cd5ab93' },
  ...
  { no: 12, title: 'N Bro.', name: 'Theophilus Knox Prah',     tenure: '2024–2025', duration: '2 years', status: 'Active',   isDeceased: false, memberId: 'ef063a65-efea-4d13-8894-f7a3ca352146' },
];

export default async function RollOfWorthyPresidentsPage() {
  const supabase = await createClient();

  // Fetch positions or members details if linked
  ...
  return (
    <RegistrarShell 
      ...
      subtitle="St. Margaret-Mary Commandery No. 500 — Official Historical Succession of Worthy Presidents (1996 – Present)"
    >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
            <div>
              <div style={{ fontSize: 13, fontWeight: 800, color: '#F59E0B', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 6 }}>
                👑 Commandery No. 500 Honor Roll & Leadership Heritage
              </div>
              ...
              <p style={{ margin: '8px 0 0', fontSize: 14, color: '#94A3B8', maxWidth: 680 }}>
                Chronological registry of the 12 Worthy Presidents who have led St. Margaret-Mary Commandery No. 500 from its founding in 1996 through present day.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <div style={{ background: 'rgba(255, 255, 255, 0.08)', backdropFilter: 'blur(8px)', padding: '14px 20px', borderRadius: 14, border: '1px solid rgba(255, 255, 255, 0.12)', textAlign: 'center' }}>
                <div style={{ fontSize: 24, fontWeight: 900, color: '#F59E0B', fontFamily: 'monospace' }}>12</div>
          ...
          <div style={{ padding: '20px 24px', background: '#F8FAFC', borderBottom: '1px solid #E2E8F0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <h3 style={{ margin: 0, fontSize: 16, fontWeight: 800, color: '#0F172A' }}>
                📜 Historical Roll & Succession Table
              </h3>
              <div style={{ fontSize: 12, color: '#64748B', marginTop: 2 }}>
                12 Worthy Presidents in order of election and term duration
              </div>
            </div>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
              ...
              <tbody>
                {WORTHY_PRESIDENTS.map((item) => {
                  ...
                  const isDeceased = item.isDeceased || dbMember?.is_deceased || dbMember?.status === 'Deceased';
                  ...
                  return (
                    <tr 
                      ...
                      style={{ 
                        ...
                        background: item.no % 2 === 0 ? '#FAFDFB' : '#FFFFFF'
                      }}
                    >
                      {/* Succession Number */}
                      <td style={{ padding: '16px 18px', textAlign: 'center', fontWeight: 900, color: '#0F172A', fontSize: 15 }}>
                        <span style={{ 
                          ...
                          background: item.no === 12 ? '#FEF3C7' : '#F1F5F9', 
                          color: item.no === 12 ? '#D97706' : '#475569',
                          ...
                          <div>
                            ...
                            {item.no === 12 && (
                              <div style={{ fontSize: 11, fontWeight: 700, color: '#166534', marginTop: 1 }}>
                                ✨ Incumbent Worthy President (2024–2025)
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <td style={{ padding: '16px 18px', fontWeight: 700, color: '#475569' }}>
                        <span style={{ background: '#F1F5F9', padding: '4px 10px', borderRadius: 6, fontSize: 12 }}>
                          ⏱️ {item.duration}
                        </span>
                      </td>
                      ...
                      <td style={{ padding: '16px 18px', textAlign: 'right' }}>
                        {item.memberId ? (
                          ...
                          <span style={{ color: '#94A3B8', fontSize: 12 }}>Archived Record</span>
                        )}
                      </td>
                    </tr>
                  );
